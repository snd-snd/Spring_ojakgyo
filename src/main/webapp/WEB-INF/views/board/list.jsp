						...
						<div class="panel-body">
							 <div class="text-center">
			                	...
			                	<c:forEach begin="${page.startPage }" end="${page.endPage }" var="idx">
			                		<li class="paginate_button ${page.criteria.pageNum==idx?'active':'' }">
			                			<a href="${idx }">${idx }</a>
			                		</li>
			                	</c:forEach>
			                	<c:if test="${page.next }">
							...
							<div class="row">						
								...
								<div class="pull-right">
									<button type="button" class="btn btn-primary" id="register" onclick="location.href='/${info.group.groupCode}/board/register'"><i class="fa fa-pencil"></i><span>&ensp;</span>글쓰기</button>										
								</div>														
							</div>
						</div>
					</div>
