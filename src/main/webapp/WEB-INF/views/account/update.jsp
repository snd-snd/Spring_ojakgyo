						...
						<div class="content">
							...
							<form id="update" class="form-auth-small" action="" method="post">
								<div class="form-group">
									...
									<input type="hidden" class="form-control" id="userId" name="userId" value="${login.member.userId}">
									<small id="userId" class="text-info"></small>
								</div>
								<div class="form-group">
									<label for="userName" class="control-label sr-only">이름</label>
									<input type="hidden" class="form-control" id="userName" name="userName" value="${login.member.userName}">
									<small id="userName" class="text-info"></small>
								</div>
								<div class="form-group">
									<label for="userPw" class="control-label sr-only">현재비밀번호</label>
									<input type="hidden" class="form-control" id="userPw" name="userPw" value="${login.member.userPw}">
