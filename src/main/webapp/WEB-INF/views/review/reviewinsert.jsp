...
<div class="main">
	...
	<div class="main-content">
		<div class="container-fluid">
			<h3 class="page-title">ReviewInsert</h3>
			<div class="row">
				<div class="col-md-6">
					<!-- INPUTS -->
					<div class="panel">
						...
						<div class="panel-body">
							<form action="reviewinsert" method="post" role="form">
								<p>Title</p>
								...
								<input class="form-control" type="hidden" name="xpos" value=""> 
								<input class="form-control" type="hidden" name="ypos" value=""> <br>
								<p class="demo-button">
